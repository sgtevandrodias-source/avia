// Lista e ordem definidas no round de UI/UX (item 5): Trabalho, Pessoal,
// Família, Casa, Saúde, Estudos, Finanças, Lazer e Social. Os ids abaixo são
// os mesmos usados na migração 0006 pra usuários já existentes — mantém tudo
// consistente entre quem já tinha conta e quem se cadastra agora.
export const CATEGORIAS_PADRAO = [
  ...
  { id: 'social', nome: 'Lazer e Social', icone: '🎉', cor: '#B084F5', ordem: 7 },
  { id: 'outro', nome: 'Outro', icone: '•', cor: '#9AA3AF', ordem: 8 },
] as const;
